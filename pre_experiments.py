...
def extract_fingerprint(model_name_or_path: str,):
    ...
    return index, token_probs

def trace_plot(index, 
               token_probs,
...
if __name__ == '__main__':
    ...
    # model_name_or_path = "/mnt/data/yuliangyan/meta-llama/Meta-Llama-3.1-8B-Instruct/"
    ...
    # model_name_or_path = "/mnt/data/yuliangyan/deepseek-ai/deepseek-llm-7b-chat/"
    # model_name_or_path = "/mnt/data/yuliangyan/deepseek-ai/deepseek-math-7b-instruct/"
    # model_name_or_path = "/mnt/data/yuliangyan/Qwen/Qwen2.5-7B/"
    ...
    index, token_probs = extract_fingerprint(model_name_or_path)
    trace_plot(index, token_probs, model_name_or_path)