...
MODEL_LIST_TEST = [
  # Llama Family.
  '/mnt/data/hf_models/llama-3.1-8b-instruct/Meta-Llama-3.1-8B-Instruct', 
  '/mnt/data/hf_models/llama-3.1-8b-instruct/meta-llama_Llama-3.1-8B-Instruct-auto_gptq-int4-gs128-asym', # not work
  ...
  # Qwen Family.
  '/mnt/data/hf_models/qwen-2.5-7b-instruct/Qwen2.5-7B-Instruct', 
  # '/mnt/data/hf_models/qwen-2.5-7b-instruct/Qwen2.5-7B-Instruct-AWQ', # not work
  # '/mnt/data/hf_models/qwen-2.5-7b-instruct/Qwen2.5-7B-Instruct-abliterated-v2', # not work
  # '/mnt/data/hf_models/qwen-2.5-7b-instruct/Qwen2.5-7B-Instruct-GPTQ-Int4', # not work
  # '/mnt/data/hf_models/qwen-2.5-7b-instruct/Qwen2.5-7B-Instruct-GPTQ-Int8', # not work
  # Mistral Family.
  '/mnt/data/hf_models/mistral-7b-instruct/Mistral-7B-Instruct-v0.1', 
  ...
  '/mnt/data/hf_models/mistral-7b-instruct/Mistral-7B-Instruct-v0.1-GPTQ', # not work
]

MODEL_LIST_UNSEEN = [
  '/mnt/data/hf_models/llama-3.2-3b-instruct/Llama-3.2-3B-Instruct',
  '/mnt/data/hf_models/llama-3.2-3b-instruct/Llama-Doctor-3.2-3B-Instruct', # not work
  '/mnt/data/hf_models/llama-3.2-3b-instruct/Llama-Sentient-3.2-3B-Instruct', # not work
  '/mnt/data/hf_models/llama-3.2-3b-instruct/Llama-3.2-3B-Instruct-4bit' # not work
]